...
tAPP_BLE_CLIENT_DB_ELEMENT *app_ble_client_db_alloc_element(void)
{
    ...
    p_element = (tAPP_BLE_CLIENT_DB_ELEMENT *)calloc(1, sizeof(*p_element));
...
tAPP_BLE_CLIENT_DB_ATTR *app_ble_client_db_alloc_attr(tAPP_BLE_CLIENT_DB_ELEMENT *p_element)
{
    ...
    if(p_attribute == NULL)
    {
         p_attribute = (tAPP_BLE_CLIENT_DB_ATTR *)malloc(sizeof(tAPP_BLE_CLIENT_DB_ATTR));
    ...
    else
    {
        ...
        n_attribute = (tAPP_BLE_CLIENT_DB_ATTR *)malloc(sizeof(tAPP_BLE_CLIENT_DB_ATTR));
