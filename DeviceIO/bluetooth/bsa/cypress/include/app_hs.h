...
#define APP_HS_SCO_IN_SOUND_FILE    "data/bsa/sco_in.wav"
#define APP_HS_SCO_OUT_SOUND_FILE    APP_HS_SCO_IN_SOUND_FILE

#define APP_HS_INVALID_CONN_INDEX   -1
#define APP_HS_INVALID_HANDLE       0xFF
...
#define BSA_HS_MAX_NUM_CONN          BSA_MAX_HS_CONNECTIONS
...
*******************************************************************************/
tAPP_HS_CONNECTION *app_hs_get_default_conn();
...
**
*******************************************************************************/
int app_hs_start(tBSA_HS_CBACK cb /* = NULL*/);
...
**
*******************************************************************************/
void app_hs_deregister_cb(void);

int app_hs_initialize(void);
